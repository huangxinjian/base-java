...
/**
 * @Author: huangxinjian
 * @Description:  自定义 HashMap 版本4
 *              完善封装，增加泛型
 * @Date: Created in 21:21 2019/2/23
 * @Modified By:
 */
public class CustomHashMap4<K,V> {
    ...
    public CustomHashMap4() {
        this.table = new Node3[DEFAULT_ARRAY_LENGTH];
    }
    ...
    public V get(K key){
        ...
        Node3 temp = table[myHash(key.hashCode(),table.length)];
        //2. 判断 temp是否为null
        if (temp != null){
            //3. 逐个比较hash值
            while (temp != null){
    ...
    public void put(K key,V value){
        ...
        Node3 node = table[newNode.hash];  //先获取当前hash值索引的数组的值
        Node3 lastNode = null;  //当前遍历的最后一个节点
...
//        System.out.println(keyHashCode % length) ;  //计算hash值，使用%运算
    ...
    public static void main(String[] args) {
        CustomHashMap4<Integer,String> c = new CustomHashMap4<>();
        c.put(10,"aa");
        c.put(11,"ww");
        c.put(12,"gg");
        c.put(13,"ff");
